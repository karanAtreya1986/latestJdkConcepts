...
public class ConvertCollectionsToStreamsAndCheckOGData {
	...
	public static void main(String[] args) {
		...
		// try to print the original data
		// In streams, the original data on which stream is applied will never change.
		System.out.println("original list is intact ----------->");
		for (String shoppingitemsString : shoppingList) {
			System.out.println(shoppingitemsString + " ");
		}
